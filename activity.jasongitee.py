...
async def process_repositories():
    # 从 Excel 文件读取数据
    repo_data = pd.read_excel(r"D:\Open Rank\data\repo_list_gitee.xlsx")
    ...
    # 保存为新的 Excel 文件
    repo_data.to_excel("repo_gitee_activity_M.xlsx", index=False)
    print("Data has been saved to repo_gitee_activity_M.xlsx")
